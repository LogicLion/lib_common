...
object AppManager {
    ...
    private val mActivityLifecycleCallbacks = object : Application.ActivityLifecycleCallbacks {
        ...
        override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
            onCreate(activity)
            Log.i("AppManager", "Activity: ${activity?.javaClass?.simpleName} ----> onActivityCreated")
        }
        ...
        override fun onActivityStarted(activity: Activity) {
            ...
            foregroundCount++
            Log.i("AppManager", "Activity: ${activity.javaClass?.simpleName} ----> onActivityStarted")
        }

        override fun onActivityResumed(activity: Activity) {
            Log.i("AppManager", "Activity: ${activity.javaClass?.simpleName} ----> onActivityResumed")
        }

        override fun onActivityPaused(activity: Activity) {
            Log.i("AppManager", "Activity: ${activity.javaClass?.simpleName} ----> onActivityPaused")
        }
